...
list_bbox = []
pixel_cm_ratio = 1
ip = "https:/192.168.84.124:8080/video"
...
if n > 0:
    for i in range(n):
        ...
        list_h.append(round((list_lower_hsv[i][0] + list_upper_hsv[i][0])/2))
        ...
        while(True):
            ...
            if captura_ok:
                ...
                if key == 13: #Enter
                    ...
                    plot_bar_charts.plotar_graficos(n, list_bar_colors_rgb_string, list_bar_h, list_bar_colors_rgb_percent)
                    break
